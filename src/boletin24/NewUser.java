...
public class NewUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "staff", "grupo2", "grupo3" }));

        jTextField4.setText("(automatic)");
        jTextField4.setEnabled(false);

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "/bin/ksh", "/home/.cache" }));

        jPasswordField1.setText("vbhjbgreiudbguire");

        jPasswordField2.setText("vbhjbgreiudbguire");
